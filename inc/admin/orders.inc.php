...
<tr>
  ...
  <td><?php echo $order['Total'].' BTC'; ?></td>
  ...
  if ($key_data[0] === 'empty') {
    if (strpos($key_data[1], 'coinbase') !== false) {
	  if (!empty($order['TranCode'])) {
	    ...
	    echo "<td colspan='4'><a target='_blank' href='https://coinbase.com/orders/$tc'>View Coinbase order</a></td>";
	  } else {
	    echo "<td colspan='4'><a target='_blank' href='https://coinbase.com/orders'>View Coinbase orders</a></td>";
	  }
    } elseif (strpos($key_data[1], 'gocoin') !== false) {
	  if (!empty($order['TranCode'])) {
	    $tc = safe_str($order['TranCode']);
	    echo "<td colspan='4'><a target='_blank' href='https://dashboard.gocoin.com/invoices/$tc'>View GoCoin order</a></td>";
	  } else {
	    echo "<td colspan='4'><a target='_blank' href='https://dashboard.gocoin.com/merchants/$gocoin_merch_id/invoices/'>View GoCoin orders</a></td>";
	  }
	} else {
